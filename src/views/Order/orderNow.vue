    ...
    <div class="container">
      ...
      <div class="product">
        ...
        <div class="product-item">
          ...
          <div class="info">
            <span class="tittle">{{ data.title }}</span>
            <span class="price">
              &yen;<i>{{ data.price }}</i
            >.00<span class="rule"
            >{{ data.price }} * {{ data.count }}</span
            ></span
            >
            <span class="tips-box">
              <span class="tips">
      ...
      <div class="order">
        ...
        <div class="total">
          ...
          >&yen;<i class="text-large">{{data.price}}</i
          ></span
          >
        </div>
      </div>
...
export default {
  ...
  methods: {
    async getProductData(productId) {
      ...
      const res = await get("/getOrderNow", {
        username,
        productId
      });
      console.log(res);
